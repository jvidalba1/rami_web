...
ActiveRecord::Schema.define(:version => 20150526031623) do
  ...
  create_table "inmuebles", :force => true do |t|
    ...
    t.string   "celular_encargado"
    t.string   "email_encargado"
    t.integer  "trato_destino_reporte"
    t.string   "nombre_destino_reporte"
    t.string   "cargo_destino_reporte"
  end
  ...
  add_index "inmuebles_interesados", ["inmueble_id", "interesado_id"], :name => "index_inmuebles_interesados_on_inmueble_id_and_interesado_id"
